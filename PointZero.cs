...
namespace BunnyMod
{
    ...
    public class PointZero : CompanionItem
    {
        ...
        public static GameObject PointZeroPrefab;

        // Token: 0x04000017 RID: 23
        public static readonly string guid = "uhhhsubtochillvix";
        ...
        public class PointZeroBehaviour : CompanionController
        {
        ...
        public class PointZeroAttackBehavior : AttackBehaviorBase
        {
