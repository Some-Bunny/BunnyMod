...
namespace BunnyMod
{
	public class NuclearTentacle : GunBehaviour
	{
		...
		public static void Add()
		{
			...
			projectile.baseData.damage *= 2.1f;
			...
			projectile.SetProjectileSpriteRight("nucleartentacle_projectile_001", 32, 32, true, tk2dBaseSprite.Anchor.MiddleCenter, new int?(16), new int?(16), null, null, null);
