...
namespace GungeonAPI
{
	...
	public static class Tools
	{
		...
		public static void ExportTexture(Texture texture, string folder = "")
		{
			...
			File.WriteAllBytes(Path.Combine(text, texture.name + DateTime.Now.Ticks.ToString() + ".png"), ImageConversion.EncodeToPNG((Texture2D)texture));
		}
		...
		public static string modID = "bny";
