...
public class MithRixOnReloadModifier : MonoBehaviour
{
	// Token: 0x0600700B RID: 28683 RVA: 0x002B7FC9 File Offset: 0x002B61C9
	public MithRixOnReloadModifier()
	{
		this.AuraRadius = 8.5f;
		this.DamagePerSecond = 25f;
		this.RadiusSynergyRadius = 8.5f;
	}
